        ...
        <Container>
          <div className="relative z-10 max-w-[680px]">
            ...
            <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white drop-shadow-md md:text-lg">
              Serving Vancouver, Burnaby and the Lower Mainland since 2007. Every job and project is personally overseen by the owner and built on something simple: honest work, respect for our clients, and pride in doing things the right way.
            </p>
      ...
      <section className="heritage-grain py-20 md:py-28">
        <Container>
          <div className="mb-16">
            ...
            <p className="text-[#756b64] text-lg mt-4 max-w-3xl">Complete flooring services, from supply and install to install only, with every stage professionally handled, from floor preparation to the final finish, serving homeowners, businesses, retail spaces, and multifamily projects across Vancouver, Burnaby, and the Lower Mainland.</p>
          </div>
