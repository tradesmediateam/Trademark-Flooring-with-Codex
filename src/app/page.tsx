        ...
        <Container>
          <div className="relative z-10 max-w-[680px]">
            ...
            <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white drop-shadow-md md:text-lg">
              Serving Vancouver, Burnaby and the Lower Mainland since 2007. Every project is personally overseen by the owner and built on something simple: honest work, respect for our clients, and pride in doing things the right way.
            </p>
